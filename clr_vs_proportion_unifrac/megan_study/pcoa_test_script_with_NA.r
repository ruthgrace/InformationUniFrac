...
# notNA <- which(!is.na(MyMetaOrdered$HM_GROUP))

# MyMetaOrdered <- MyMetaOrdered[notNA,]
# data.otu.tab <- data.otu.tab[notNA,]
...
# write.table(unweightedUnifrac,file="noNA_unweightedUniFracDistanceMatrix.txt",append=FALSE,quote=FALSE,sep="\t")
# write.table(weightedUnifrac,file="noNA_weightedUniFracDistanceMatrix.txt",append=FALSE,quote=FALSE,sep="\t")
# write.table(eUnifrac,file="noNA_eUniFracDistanceMatrix.txt",append=FALSE,quote=FALSE,sep="\t")
...
# pdf("megan_data_noNA_pcoa_plots.pdf")
