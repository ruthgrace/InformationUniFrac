...
\begin{figure}[h!]
  ...
  \caption{Examples of the UniFrac calculation}
    ...
    \text{This image was taken from the \href{http://unifrac.colorado.edu/static/images/fastunifrac/unifrac_significance/unifrac_test.jpg}{University of Colorado Boulder UniFrac page}}
\end{figure}
